...
export default function BottomNavigationBar (props: IBottomNavigationBarProps) {
    ...
    const setActiveMenuFunction=(activeMenu:number)=>{
     // console.log('activeSubMenu',{activeSubMenu,activeMenu})
     setActiveSubMenu(active=>{
      console.log('activeSubMenu',{active,activeMenu})
...
export function BottomNavMenu (props: IBottomNavMenuProps) {
  return (
    ...
    <div  onClick={props.onClick?()=>{props.onClick && props.onClick()}:()=>{}} className={`${props.active?'bg-sideBarHover border-t-primary-500':'border-t-borderColor'} ${props.className} border-t-[1.5px] text-f10 flex-1 flex flex-col items-center text-center gap-2  p-5  hover:bg-sideBarHover hover:border-t-primary-500 `}>
...
export function BottoMoreNavMenu (props: IBottomMoreNavMenuProps) {
    return (
      <div  onClick={()=>props.onClick()} className={`${props.active?'bg-sideBarHover border-t-primary-500':'border-t-borderColor'} ${props.className} border-t-[1.5px] text-f10 flex-1 flex flex-col items-center justify-center  gap-2  p-5  hover:bg-sideBarHover hover:border-t-primary-500 `}>
