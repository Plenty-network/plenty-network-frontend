...
export default function BottomNavigationBar (props: IBottomNavigationBarProps) {
  return (
    <div className='mobile-flex fixed bottom-0 justify-between w-screen p-0 '>
    <BottomNavMenu/>
    <BottomNavMenu/>
    <BottomNavMenu/>
    <BottomNavMenu/> 
...
export function BottomNavMenu (props: IBottomNavMenuProps) {
  return (
    <div className='border-t-[1.5px] text-f10 flex-1 flex flex-col items-center text-center gap-2 border-t-navBarBorder p-5  hover:bg-sideBarHover hover:border-t-primary-500 '>
    ...
    return (
      <div className='border-t-[1.5px] text-f10 flex-1 flex flex-col justify-center items-center text-center gap-2 border-t-navBarBorder p-5  hover:bg-sideBarHover hover:border-t-primary-500 '>
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_4328_25645)">
