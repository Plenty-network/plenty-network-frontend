...
export default function HeadInfo (props: IHeadInfoProps) {
  ...
  return (
      <div className={`${props.className} flex justify-between items-center border-b border-b-borderCommon py-2 pt-7 md:pt-2 bg-cardBackGround`}>
           ...
           <InputSearchBox className='md:hidden' value={props.searchValue} onChange={props.setSearchValue} />
