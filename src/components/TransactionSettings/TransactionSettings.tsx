...
function TransactionSettings(props: ITransactionSettingsProps) {
  ...
  return props.show ? (
    <div
      ...
      style={{ top: "0px" }}
      className={clsx(
        "z-20 absolute right-[10px]  md:right-[27px]  bg-card-500 border border-text-700/[0.5] w-[270px] md:w-[326px] p-5 rounded-2xl fade-in-3 ",
    ...
    >
      ...
      <div className="flex mt-3">
        ...
        >
          <p>
            <input
              className="outline-none bg-card-500 text-left w-full"
              placeholder="0.5"
