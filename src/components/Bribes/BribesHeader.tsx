...
export enum BribesCardHeader {
  Pools = "Pools",
  Mybribes = "My bribes",
}
export function BribesHeader(props: ICardHeaderProps) {
  ...
  return (
    <div className="flex md:justify-between items-center justify-center border-b border-b-borderCommon  bg-cardBackGround">
      ...
      >
        {PoolsHeaderCard(BribesCardHeader.Pools, 0, "")}
        {PoolsHeaderCard(BribesCardHeader.Mybribes, 1, "")}
      </div>
      <InputSearchBox
