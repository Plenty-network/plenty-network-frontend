...
function BottomCard(props: ILandingPageProps) {
  ...
  return (
    <>
      <div
        className={clsx(
          " rounded-lg	flex md:block justify-between flex-col landingBottom ml-6 mr-6 md:mx-6  p-4 md:px-2.5 md:py-[14px] w-auto  md:w-[184px] h-[194px] md:h-[105px] cursor-pointer "
        )}
