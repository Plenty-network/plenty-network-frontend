...
export function BtnWithWalletIcon (props: IWalletBtnWithIconProps) {
  return (
    <div className={`ml-auto border border-text-800/[0.5] rounded-lg bg-cardBackGround h-[48px] items-center flex px-3 ${props.className}`}>
              <div>
...
export function BtnWithStakeIcon (props: IWalletBtnWithIconProps) {
  return (
    <div className={`ml-auto border border-text-800/[0.5] rounded-lg bg-cardBackGround h-[36px] items-center flex px-3 ${props.className}`}>
              <div>
