...
function VotingAllocation(props: IVotingAllocationProps) {
  ...
  return (
    <div className="md:border mt-3 rounded-xl border-text-800/[0.5] md:bg-card-400 md:py-[26px] md:px-[22px] md:h-[calc(100vh_-_236px)] lg:h-[calc(100vh_-_236px)] lg:min-h-[475px]">
