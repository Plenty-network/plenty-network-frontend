...
export function VideoModal (props: IVideoModalProps) {
  ...
  return (
    <div>
      <PopUpModal onhide={closefn} className='md:w-max w-screen max-w-none md:h-max ' >
       <div className="modal-video-movie-wrap"  onClick={()=>closefn(false)}>
         ...
         <iframe src={`//www.youtube.com/embed/${linkString}?autoplay=1`} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
         }
        </div>
      </PopUpModal>
    </div>
