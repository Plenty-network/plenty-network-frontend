...
export function VideoModal (props: IVideoModalProps) {
  ...
  return (
    <div>
      <PopUpModal isFullSizeOnMobile onhide={closefn} className='md:w-max w-screen max-w-none md:h-max ' >
       ...
       <div>
         ...
         <iframe width={width<560?width:560} height={height<315?height:315} src={`//www.youtube.com/embed/${linkString}?autoplay=1`} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
         }
        </div>
      </PopUpModal>
    </div>
