...
export const directSwapWrapper = async (
 ...
 const swapTokens = async (
    ...
    try {
      ...
      minimumTokenOut = minimumTokenOut.multipliedBy(Math.pow(10, TOKEN_OUT.decimals));
      ...
      const batch = Tezos.wallet.batch([
        {
          ...
          ...contract.methods
            .tez_to_ctez(minimumTokenOut.multipliedBy((10 ** tokenOutDecimals)).toString(), recipent)
            .toTransferParams({ amount: tokenInAmount.multipliedBy((10 ** tokenInDecimals)).toNumber(), mutez: true }),
        },
      ]);
